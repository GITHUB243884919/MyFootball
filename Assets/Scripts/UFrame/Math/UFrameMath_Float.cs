...
namespace UFrame
{
    public class Math_F
    {
        ...
        public static string OnDounbleToFormatTime_ToRefreshTime()
        {
            long remainTime = GetRemainTime_ToRefreshTime();

            return OnDounbleToFormatTime_Anhour((int)(remainTime/1000));
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static long GetRemainTime_ToRefreshTime()
        {
            //每日0点刷新
            System.DateTime tomorrow = new System.DateTime(System.DateTime.Now.Year, System.DateTime.Now.Month, System.DateTime.Now.Day);
            long t = 24 * 3600*1000 - (System.DateTime.Now.Ticks - tomorrow.Ticks) / 10000;
            return t;
        }
