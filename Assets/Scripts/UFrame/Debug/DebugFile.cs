...
namespace UFrame
{
    public class DebugFile : Singleton<DebugFile>, ISingleton
    {
        ...
        public void WriteAppsGetEventFile_TA(string platformName, string eventName, Dictionary<string, object> properties = null)
        {
        ...
        [Conditional("GET_EVENT")]
        public void WriteAppsGetEventFile_APS(string platformName, string eventName)
        {
            eventName = "事件名= " + eventName;
            //if (properties != null)
            //{
